    ...
    return (
        <div className='space-y-4 ' id='experience'>
            ...
            <div className=' hover:bg-[rgba(255,255,255,0.1)] py-2 px-2 rounded-md group space-y-2'>
                <a className='flex items-center group-hover:items-start group-hover:text-[#58ffcf] text-lg font-semibold   ' href="https://www.vendalyn.com/" target="_blank" >Software Developer Intern, 1BUY.AI &nbsp;<ArrowUpRight size={16} /></a>
            ...
            <div className=' hover:bg-[rgba(255,255,255,0.1)] py-2 px-2 rounded-md group space-y-2'>
                <a className='flex items-center group-hover:items-start group-hover:text-[#58ffcf] text-lg font-semibold   ' href="https://www.vendalyn.com/" target="_blank" >Software Developer Intern, Guardant Security &nbsp;<ArrowUpRight size={16} /></a>
                <p className='text-gray-400 text-justify text-[1rem]'>
